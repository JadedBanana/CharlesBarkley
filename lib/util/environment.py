...
EXPECTED_DOTENV_VARS = [
    ...
    'USERWAS_MAX_CHAIN_LENGTH', 'USERWAS_REPLY_CHECK_MAX_LENGTH',
    'DISABLED_COMMANDS'
]
...
EXPECTED_DOTENV_TYPES = {
    ...
    'HUNGER_GAMES_EXPIRE_CHECK_INTERVAL': int,
    'MAL_ANIME_COUNT': int,
    'MAL_MANGA_COUNT': int,
    'USERWAS_MAX_CHAIN_LENGTH': int,
    'USERWAS_REPLY_CHECK_MAX_LENGTH': int,
