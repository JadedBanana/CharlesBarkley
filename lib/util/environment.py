...
EXPECTED_DOTENV_VARS = [
    ...
    'YOUTUBE_API_KEY',
    'WEATHER_API_KEY',
    'HUNGER_GAMES_EXPIRE_SECONDS', 'HUNGER_GAMES_EXPIRE_CHECK_INTERVAL',
    'UNO_EXPIRE_SECONDS', 'UNO_EXPIRE_CHECK_INTERVAL', 'UNO_BUTTONS_TIMEOUT_SECONDS',
    'UNO_DISABLE_OLD_VIEW_ON_REFRESH', 'UNO_ALLOW_DUPLICATE_PLAYERS_IN_GAME',
...
EXPECTED_DOTENV_TYPES = {
    'DEPLOYMENT_CLIENT': bool, 'LAUNCH_RUN_CRONCHECK': bool, 'DEVELOPER_DISCORD_IDS': list,
    'LOGGING_LEVEL': int, 'LOG_TO_FILE': bool,
    'EXIT_ON_DATABASE_FAILURE': bool, 'DISABLE_COMMANDS_WITH_MISSING_DATABASE_TABLES': bool,
    'CLEAR_TEMPORARY_DATABASE_TABLES_ON_STARTUP': bool,
    'HUNGER_GAMES_EXPIRE_SECONDS': int, 'HUNGER_GAMES_EXPIRE_CHECK_INTERVAL': int,
    'UNO_EXPIRE_SECONDS': int, 'UNO_EXPIRE_CHECK_INTERVAL': int, 'UNO_BUTTONS_TIMEOUT_SECONDS': int,
    'UNO_DISABLE_OLD_VIEW_ON_REFRESH': bool, 'UNO_ALLOW_DUPLICATE_PLAYERS_IN_GAME': bool,
    'MAL_ANIME_COUNT': int,
    'MAL_MANGA_COUNT': int,
