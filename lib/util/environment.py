...
EXPECTED_DOTENV_VARS = [
    ...
    'UNO_EXPIRE_SECONDS', 'UNO_EXPIRE_CHECK_INTERVAL', 'UNO_ALLOW_DUPLICATE_PLAYERS_IN_GAME',
...
EXPECTED_DOTENV_TYPES = {
    ...
    'UNO_EXPIRE_SECONDS': int, 'UNO_EXPIRE_CHECK_INTERVAL': int, 'UNO_ALLOW_DUPLICATE_PLAYERS_IN_GAME': bool,
    'MAL_ANIME_COUNT': int,
    'MAL_MANGA_COUNT': int,
