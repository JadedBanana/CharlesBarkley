...
ULTIMATE_TALENTS = {
    ...
    'Actress': {'desc': '! Try as they might, no one could ever hope to emulate the passion {0} put into {1} performances!'},
    'Adventurer': {'desc': '! Well, who doesn\'t love discovering lands unknown?'},
    'Affluent Progeny': {'desc': '. Heir to the world\'s elite, {0} are destined to rule the world from the shadows.'},
    'Akido Master': {'desc': '! Hi-yah!'},
    'Analyst': {'desc': '. {7} can dissect any situation and see things most other people can\'t.'},
    'Angler': {'desc': '. No one really gets how to gut a fish quite like {0}.'},
    'Animator': {'desc': '! Don\'t forget! Anime is art!'},
    'Anthropologist': {'desc': '. {7} know more about the Salem Witch Trials than anyone else on Earth.'},
    'Archer': {'desc': '! {9} like Hawkeye up in here!'},
    'Architect': {'desc': '. {8} houses are absolutely exquisite.'},
    'Artist': {'desc': '! Pretty colors and lifelike statues are {1} whole deal!'},
    'Assassin': {'desc': '. Here\'s the target. You have 24 hours.'},
    'Astronaut': {'desc': '! {7} can reach the stars for sure! If anyone can, it\'s {6}!'},
    'Baseball Player': {'desc': '! Batter up!'},
    'Beatboxer': {'desc': '! Boots and cats and boots and cats...'},
    'Blacksmith': {'desc': '! Daggers and knives and swords, oh my!'},
    'Biker Gang Leader': {'desc': '! Rev your fucking engines! Let\'s tear up this town!'},
    'Biologist': {'desc': '. {8} favorite joke is that one about mitosis.'},
    'Bodyguard': {'desc': '. Are {0} prepared to lay down {1} life?'},
    'Botanist': {'desc': '! Ooh, pretty!'},
    'Bounty Hunter': {'desc': '. Feel like hunting down any criminals?'},
    'Boxer': {'desc': '! *DING-DING-DING!* It\'s a TKO!'},
    'Breakdancer': {'desc': '! Kick it!'},
    'Breeder': {'desc': '! Use {1} prowess in the dark arts to... potty-train this dog!'},
    'Broadway Singer': {'desc': '. What\'s {1} favorite musical?'},
    'CGI Artist': {'desc': '! It looks so *real!*'},
    'Cheerleader': {'desc': '! {14}, they\'re the one, if they don\'t win then that\'s no fun!'},
    'Chemist': {'desc': '. Man, that\'s such a boron career. It\'s too basic, if you ask me.'},
    'Child Caregiver': {'desc': '. {9} basically like a goblin herder.'},
    'Clairvoyant': {'desc': '! {7} and {1} 30% accuracy rate can predict ANY crime that probably won\'t happen!'},
    'Clown': {'desc': '! {9} a clown! Honk honk! :o)'},
    'Composer': {'desc': '. Popping out songs one after another ain\'t easy, but it\'s {1} way of life.'},
    'Con Artist': {'desc': '. {9} a slimy bastard who can convince anyone anything is a good idea.'},
    'Confectioner': {'desc': '! How sweet of {0}!'},
    'Conspiracy Theorist': {'desc': '. So you think the moon landing was faked, huh? Well, have you heard the MOON is fake, too?'},
    'Cook': {'desc': '! Bon Appetit!'},
    'Curator': {'desc': '. {8} collection is far more impressive than the Smithsonian.'},
    'Despair': {'desc': '. Despair is not a goal, or a set of principles, or a lifestyle, or even an instinct... It\'s what defines {6} as {14}!'},
    'Detective': {'desc': '! And the killer is... you!'},
    'Drug Dealer': {'desc': '. {11} stuck some stuff in some pretty gross places to get to the top, but {0} don\'t regret it.'},
    'Drummer': {'desc': '! Any band is only as good as its drummer!'},
    'DJ': {'desc': '! Lay down some beats, man!'},
    'Entomologist': {'desc': '... so, if I find a spider, do I bring it to you?'},
    'Entrepreneur': {'desc': ''},
    'Exorcist': {'desc': '. The power of Christ compels you!'},
    'Fanfic Creator': {'desc': '! So, what next? Maybe a slow-burn coffee shop AU with some self-inserts, a handful of OC\'s, F/F and M/M, a little OOC if necessary, but all in all just fanservice fic for Danganronpa?'},
    'Farmer': {'desc': '! Do {1} have a dog named Bingo? Or... just Ingo? Or Ngo?'},
    'Fashionista': {'desc': '! Looking cool, {14}!'},
    'Film Director': {'desc': '! When on set, nobody questions {1} judgement.'},
    'Forum Admin': {'desc': '. {11} seen some serious shit.'},
    'Gambler': {'desc': ''},
    'Gamer': {'desc': ''},
    'Golfer': {'desc': '. No one can beat the power of a true Scottish swing.'},
    'Guitarist': {'desc': ''},
    'Gymnast': {'desc': ''},
    'Hacker': {'desc': '. {7} didn\'t actually get {1} title from some school official, {0} got it by hacking into the servers and giving it to {3}.'},
    'Hairstylist': {'desc': ''},
    'Hope': {'desc': ''},
    'Housekeeper': {'desc': '! You\'re the ultimate cleaning machine!'},
    'Hypnotist': {'desc': '. People ought to be cautious around {6} -- let down your guard for even a second and you can no longer think for yourself.'},
    'Idol': {'desc': ''},
    'Impostor': {'desc': '. No one truly knows who {0} are beneath the mask... or that {2} even wearing one at all.'},
    'Internet Troll': {'desc': '. {9} really good at pissing people off online.'},
    'Inventor': {'desc': ''},
    'Lawyer': {'desc': ''},
    'Lucky Student': {'desc': ''},
    'Magician': {'desc': '! Prepare to be amazed!'},
    'Maid': {'desc': ''},
    'Martial Artist': {'desc': ''},
    'Makeup Artist': {'desc': ''},
    'Matchmaker': {'desc': ''},
    'Mechanic': {'desc': '. Every tractor {0} work on is sexy.'},
    'Medium': {'desc': ''},
    'Merchant': {'desc': '. No one knows supply and demand better than {6}, and {0} always have just enough stock to match what the public desires.'},
    'Model': {'desc': ''},
    'Moral Compass': {'desc': '. {7} are the best at telling other people how to act.'},
    'Musician': {'desc': ''},
    'Neurologist': {'desc': ''},
    'Ninja': {'desc': '}, lying hidden in the shadows. Watch out.'},
    'Nurse': {'desc': ''},
    'Pharmacist': {'desc': '. It\'s not totally clear how {0} managed to become one at such a young age, but regardless, {0} are.'},
    'Photographer': {'desc': '! Say cheese!'},
    'Poet': {'desc': '. {7} just have a way with words others can only dream of matching.'},
    'Prankster': {'desc': '. What devious thing did {0} do to get this title...?'},
    'Prisoner': {'desc': ''},
    'Puppeteer': {'desc': '. No strings on {1} puppets, no sir!'},
    'Psychologist': {'desc': ''},
    'Pianist': {'desc': ''},
    'Pilot': {'desc': '. Do a barrel roll!'},
    'Police Officer': {'desc': ''},
    'Priest': {'desc': '. With just a wave of {1} hand, {0} can enlighten hundreds at a time.'},
    'Princess': {'desc': ''},
    'Programmer': {'desc': '! Did you know this bot is written in Python using the discord.py API?'},
    'Pyrotechnician': {'desc': '. \'Cause baby, you\'re a firework!'},
    'Robot': {'desc': '! Beep boop bop beep!'},
    'Sailor': {'desc': ''},
    'Scout': {'desc': '. Though high adventure may be fun, there is nothing quite like giving back to one\'s community.'},
    'Secret Agent': {'desc': '. {7} have a license to kill and {0} aren\'t afraid to use it.'},
    'Serial Killer': {'desc': ''},
    'SFX Artist': {'desc': ''},
    'Skiier': {'desc': ''},
    'Soccer Player': {'desc': ''},
    'Soldier': {'desc': ''},
    'Sniper': {'desc': '. Headshot.'},
    'Snowboarder': {'desc': '. It\'s like being a skiier, but way cooler.'},
    'Surgeon': {'desc': ''},
    'Street Fighter': {'desc': ''},
    'Stunt Double': {'desc': ''},
    'Superhero': {'desc': ''},
    'Supervillain': {'desc': '! What separates a regular villain from a super one? Why, presentation, of course!'},
    'Supreme Leader': {'desc': ''},
    'Survivor': {'desc': ''},
    'Swimmer': {'desc': '! {7} swear {0} could swim across the ocean if it was legal!'},
    'Swordsman': {'desc': '. While most others spend their time playing video games or watching TV, {0} study the blade.'},
    'Tailor': {'desc': '. Capes aren\'t usually fashionable, but the way {0} make it, anyone can rock that shit.'},
    'Team Manager': {'desc': ''},
    'Tennis Pro': {'desc': ''},
    'Test Subject': {'desc': 'The Enrichment Center is committed to the well being of all participants. Cake and grief counseling will be available at the conclusion of the test.'},
    'Therapist': {'desc': '. Of course, {0} can\'t talk about it that much, since patient confidentiality is {1} number 1 priority.'},
    'Traditional Dancer': {'desc': ''},
    'Translator': {'desc': '. {8} ability to be fluent in so many language baffles scientists.'},
    'VFX Artist': {'desc': '. {7} had it better in the 80\'s.'},
    'Violinist': {'desc': ''},
    'Voice Actor': {'desc': '. {9} able to switch voices on a dime, and none of them sound anything alike.'},
    'Wrestler': {'desc': '! Let\'s settle this in the ring!'},
    'Writer': {'desc': ''},
    'Yakuza': {'desc': ''},
    'Yoga Guru': {'desc': '. All {1} chakras are open and flowing the sweet nectar of the soul.'}
}
